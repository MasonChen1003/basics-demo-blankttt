...
namespace Sequence {
    ...
    */
    ...
    export function MoveRight(): void {
        mySprite.setPosition(mySprite.x + 16, mySprite.y)
        SoundAndCheck()
    }
    /**
    * Moves the duck left
    ...
    */
    ...
    export function MoveDown(): void {
        mySprite.setPosition(mySprite.x, mySprite.y + 16)
        SoundAndCheck()
    }
    /**
     * Moves the duck up
...
function SoundAndCheck() {
    music.play(music.melodyPlayable(music.pewPew), music.PlaybackMode.UntilDone)
    if (mySprite.x > 150 || mySprite.x < 10 || (mySprite.y > 110 || mySprite.y < 0)) {
        game.gameOver(false)
    }
    pause(200)
}
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.hazardWater, function (sprite, location) {
    setTimeout(() => game.gameOver(true), 0)
})
...
for (let value2 of tiles.getTilesByType(sprites.dungeon.collectibleBlueCrystal)) {
